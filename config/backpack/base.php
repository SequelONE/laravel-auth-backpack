...
return [
    ...
    */
    ...
    'project_logo'   => '<img width="125" src="/img/logo.png" alt="SEQUEL.ONE" />',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class' => 'app-header navbar navbar-light navbar-fixed-top',
    ...
    'footer_class' => 'app-footer d-print-none bg-white border-top',
    // hide it with d-none
